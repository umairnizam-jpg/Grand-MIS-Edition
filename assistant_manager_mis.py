...
def load_excel_data():
    ...
    try:
        ...
        # Added Date Object for Advanced Range Support
...
# --- AI PREDICTION LOGIC (Requirement) ---
...
def main():
    ...
    # --- CSS FOR TEXT VISIBILITY (Requirement) ---
    st.markdown("""
        <style>
        div[data-testid="stMetricLabel"] > div { color: #58a6ff !important; font-weight: bold !important; font-size: 16px !important; }
        div[data-testid="stMetricValue"] > div { color: #ffffff !important; }
        div[data-testid="stMetric"] { background: #1c2128; border: 1px solid #30363d; border-radius: 12px; }
        </style>
    ...
    # Fixed syntax error from your screenshot
    ...
    if auth_status:
        ...
        prompt = st.chat_input("Ex: 'July 2018 to Dec 2024' or 'April 2027 forecast'...")
        ...
        if st.session_state.last_filtered_df is not None:
            ...
            chart_option = st.selectbox("🎯 Select Chart", [
                ...
                "3. Revenue: Actual vs Target (Bar)", "4. Revenue Trend (Line)",
                "5. Monthly Revenue Share (Pie)", "6. Revenue Target Funnel"
            ])
        ...
        st.info("Developed by **Umair Nizam**. Please login.")
